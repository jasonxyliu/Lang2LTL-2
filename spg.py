...
from openai_models import TextEmbedding
...
def find_closest_relation(rel):
    ...
    for R in evaluated_spatial_relations:
        if not closest_rel:
            ...
            current_score = np.dot(txt_embed_model.embed(rel), txt_embed_model.embed(closest_rel))
            new_rel_score = np.dot(txt_embed_model.embed(rel), txt_embed_model.embed(R))
